...
<div class="wrapper">
  <header class="main-header">
      ...
      <a href="/index/Admin/Index/index" class="logo">
        ...
        <span class="logo-lg"><img src="Public/images/ego_logo.png" width="40" height="30">&nbsp;&nbsp;<b>ego</b></span>
      </a>
	      ...
	      <li class="treeview">
	            ...
	            <ul class="treeview-menu">
	            	<li onclick="makecss(this)" data-id="categoryList_Goods">
	            		<a href='product/category/list' target='rightContent'><i class="fa fa-circle-o"></i>商品分类</a>
	            	</li><li onclick="makecss(this)" data-id="goodsList_Goods">
	            		<a href='product/list' target='rightContent'><i class="fa fa-circle-o"></i>商品列表</a>
